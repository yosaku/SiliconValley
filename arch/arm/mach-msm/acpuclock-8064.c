...
static struct msm_bus_paths bw_level_tbl[] __initdata = {
	...
	[1] = BW_MBPS(1104), /* At least 138 MHz on bus. */
	[2] = BW_MBPS(1720), /* At least 215 MHz on bus. */
	[3] = BW_MBPS(2240), /* At least 280 MHz on bus. */
	[4] = BW_MBPS(3480), /* At least 435 MHz on bus. */
	[5] = BW_MBPS(4400), /* At least 550 MHz on bus. */
};
...
static struct acpu_level tbl_PVS0_1700MHz[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   900000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(1),   900000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(3),   900000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(4),   912500 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(5),   950000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(6),  975000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(7),  987500 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(8), 1025000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(8), 1037500 },
...
static struct acpu_level tbl_PVS1_1700MHz[] __initdata = {
	...
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(3),   900000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(4),   912500 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(5),   925000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(6),  950000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(7),  962500 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(8),  987500 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(8), 1000000 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(9), 1037500 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(9), 1062500 },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(9), 1100000 },
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(9), 1137500 },
...
static struct acpu_level tbl_PVS2_1700MHz[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   875000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(1),   875000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(3),   875000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(4),   875000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(5),   887500 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(6),  900000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(7),  925000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(8),  950000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(8),  962500 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(9),  987500 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(9), 1025000 },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(9), 1050000 },
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(9), 1087500 },
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(9), 1112500 },
	{ 0, { 0 } }
};

static struct acpu_level tbl_PVS3_1700MHz[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   850000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(1),   850000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(3),   850000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(4),   850000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(5),   850000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(6),  875000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(7),  900000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(8),  925000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(8),  937500 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(9),  950000 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(9),  987500 },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(9), 1012500 },
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(9), 1050000 },
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(9), 1085000 },
	{ 0, { 0 } }
};

static struct acpu_level tbl_PVS4_1700MHz[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   825000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(1),   825000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(3),   825000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(4),   825000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(5),   837500 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(6),  850000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(7),  875000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(8),  900000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(8),  912500 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(9),  925000 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(9),  950000 },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(9),  987500 },
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(9), 1025000 },
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(9), 1050000 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS5_1700MHz[] __initdata = {
	...
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(6),  850000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(7),  875000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(8),  887500 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(8),  900000 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(9),  912500 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(9),  937500 },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(9),  962500 },
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(9), 1000000 },
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(9), 1025000 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS6_1700MHz[] __initdata = {
	...
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(8),  900000 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(9),  912500 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(9),  925000 },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(9),  950000 },
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(9),  975000 },
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(9), 1000000 },
	{ 0, { 0 } }
};
